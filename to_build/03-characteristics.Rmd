...
knitr::include_graphics("../workspace/img/meanPPT.png")
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics("../workspace/../workspace/img/snowfrac.png")
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics("../workspace/img/high_ppt_freq.png")
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics("../workspace/img/low_ppt_freq.png")
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics("../workspace/img/high_dur_ppt.png")
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics("../workspace/img/low_dur_ppt.png")
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics("../workspace/img/pet.png")
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics("../workspace/img/ai.png")
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics("../workspace/img/mean_elevation.png")
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics("../workspace/img/mean_slope.png")
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics("../workspace/img/permeability.png")
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics("../workspace/img/carbonates.png")
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics("../workspace/img/clay.png")
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics("../workspace/img/silt.png")
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics("../workspace/img/sand.png")
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics("../workspace/img/k.png")
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics("../workspace/img/vp.png")
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics("../workspace/img/rockdepth.png")
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics("../workspace/img/mwc.png")
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics("../workspace/img/forest.png")
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics("../workspace/img/max_gvf.png")
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics("../workspace/img/dif_gvf.png")
```
